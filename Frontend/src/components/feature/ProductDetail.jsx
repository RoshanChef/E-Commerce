...
function ProductDetail() {
    ...
    function addToCart() {
        ...
        if (userFromStore == null)
            ...
            dispatch(add_To_Cart(navigate,product._id));
    }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                    ...
                    ${mainImg === img
                            ...
                            <div className="flex-1 bg-gray-50 rounded-2xl overflow-hidden relative group border border-gray-100">
                                ...
                                <button className="absolute top-4 right-4 p-3 bg-white/80 backdrop-blur-md rounded-full hover:bg-white transition shadow-md active:scale-95">
                                    <Heart
                                        size={20}
                  ...
                  ${mainImg === img
                        ...
                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                            <div className="flex flex-wrap items-end gap-3">
                                ...
                                <span className="text-lg text-gray-400 line-through">
                                    ₹{(product.price + 1200).toLocaleString()}
                                </span>
                    ...
                    ${selectedSize === item.size
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-2">
                            <button onClick={addToCart} state={{ product }} className="flex items-center justify-center cursor-pointer flex-1 bg-blue-600 hover:bg-blue-700 text-white h-14 rounded-xl font-bold text-lg shadow-lg shadow-blue-200 transition-all active:scale-95">
                                Add to Cart
                            </button>
